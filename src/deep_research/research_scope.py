...
from typing_extensions import TypedDict, Sequence, Annotated, List, Dict, Any
import uuid
...
class ToolCall(BaseModel):
    """
    Represents a single tool call instruction from the LLM.
    """
    id: str = Field(default_factory=lambda: str(uuid.uuid4()), description="Unique ID for this tool call")
